...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'periodicals_article', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Article.announce'
        db.add_column(u'periodicals_article', 'announce',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Article.content'
        db.add_column(u'periodicals_article', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'periodicals_article', 'subtitle')

        # Deleting field 'Article.announce'
        db.delete_column(u'periodicals_article', 'announce')

        # Deleting field 'Article.content'
        db.delete_column(u'periodicals_article', 'content')
