...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.description'
        db.add_column(u'periodicals_series', 'description',
                      self.gf('djangocms_text_ckeditor.fields.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Series.image'
        db.add_column(u'periodicals_series', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'series_images', null=True, to=orm['filer.Image']),
                      keep_default=False)

        # Adding field 'Series.is_commercial'
        db.add_column(u'periodicals_series', 'is_commercial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.description'
        db.delete_column(u'periodicals_series', 'description')

        # Deleting field 'Series.image'
        db.delete_column(u'periodicals_series', 'image_id')

        # Deleting field 'Series.is_commercial'
        db.delete_column(u'periodicals_series', 'is_commercial')
