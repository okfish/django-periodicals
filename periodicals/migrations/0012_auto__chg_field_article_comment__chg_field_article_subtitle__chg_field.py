...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'periodicals_article', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Article.subtitle'
        db.alter_column(u'periodicals_article', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Article.read_online'
        db.alter_column(u'periodicals_article', 'read_online', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Article.title'
        db.alter_column(u'periodicals_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Article.content'
        db.alter_column(u'periodicals_article', 'content', self.gf('djangocms_text_ckeditor.fields.HTMLField')(null=True))

        # Changing field 'Article.announce'
        db.alter_column(u'periodicals_article', 'announce', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Article.description'
        db.alter_column(u'periodicals_article', 'description', self.gf('djangocms_text_ckeditor.fields.HTMLField')(null=True))

        # Changing field 'Article.buy_print'
        db.alter_column(u'periodicals_article', 'buy_print', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Article.organization'
        db.alter_column(u'periodicals_article', 'organization', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Article.buy_digital'
        db.alter_column(u'periodicals_article', 'buy_digital', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Article.comment'
        db.alter_column(u'periodicals_article', 'comment', self.gf('django.db.models.fields.TextField')(default='', max_length=200))

        # Changing field 'Article.subtitle'
        db.alter_column(u'periodicals_article', 'subtitle', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Article.read_online'
        db.alter_column(u'periodicals_article', 'read_online', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Article.title'
        db.alter_column(u'periodicals_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Article.content'
        db.alter_column(u'periodicals_article', 'content', self.gf('djangocms_text_ckeditor.fields.HTMLField')(default=''))

        # Changing field 'Article.announce'
        db.alter_column(u'periodicals_article', 'announce', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Article.description'
        db.alter_column(u'periodicals_article', 'description', self.gf('djangocms_text_ckeditor.fields.HTMLField')(default=''))

        # Changing field 'Article.buy_print'
        db.alter_column(u'periodicals_article', 'buy_print', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Article.organization'
        db.alter_column(u'periodicals_article', 'organization', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Article.buy_digital'
        db.alter_column(u'periodicals_article', 'buy_digital', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
