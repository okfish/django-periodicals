...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'periodicals_article', 'article_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'article_images', null=True, to=orm['filer.Image'], blank=True),
                      keep_default=False)

        # Deleting field 'Article.image'
        db.delete_column(u'periodicals_article', 'image_id')
