...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.user'
        db.add_column(u'periodicals_author', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name=u'author_profile', unique=True, null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Author.image'
        db.add_column(u'periodicals_author', 'image',
        ...
        # Adding field 'Author.position'
        db.add_column(u'periodicals_author', 'position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Author.comment'
        db.add_column(u'periodicals_author', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'Author.middle_name'
        db.alter_column(u'periodicals_author', 'middle_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Author.postnomial'
        db.alter_column(u'periodicals_author', 'postnomial', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Author.user'
        db.delete_column(u'periodicals_author', 'user_id')
        ...
        # Deleting field 'Author.comment'
        db.delete_column(u'periodicals_author', 'comment')


        # Changing field 'Author.middle_name'
        db.alter_column(u'periodicals_author', 'middle_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Author.postnomial'
        db.alter_column(u'periodicals_author', 'postnomial', self.gf('django.db.models.fields.CharField')(max_length=100))
