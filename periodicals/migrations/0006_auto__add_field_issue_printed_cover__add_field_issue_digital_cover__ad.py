...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'periodicals_issue', 'printed_cover',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'issue_printed_covers', null=True, to=orm['filer.Image']),
                      keep_default=False)

        # Adding field 'Issue.digital_cover'
        db.add_column(u'periodicals_issue', 'digital_cover',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'issue_digital_covers', null=True, to=orm['filer.Image']),
                      keep_default=False)
        ...
        # Adding field 'Article.article_image'
        db.add_column(u'periodicals_article', 'article_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'article_images', null=True, to=orm['filer.Image']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'periodicals_issue', 'printed_cover_id')

        # Deleting field 'Issue.digital_cover'
        db.delete_column(u'periodicals_issue', 'digital_cover_id')

        # Deleting field 'Article.tags'
        db.delete_column(u'periodicals_article', 'tags')

        # Deleting field 'Article.article_image'
        db.delete_column(u'periodicals_article', 'article_image_id')

        # Deleting field 'Periodical.logo'
        db.delete_column(u'periodicals_periodical', 'logo_id')
    ...
    models = {
        ...
        u'periodicals.article': {
            ...
            'article_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'article_images'", 'null': 'True', 'to': "orm['filer.Image']"}),
