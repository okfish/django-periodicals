...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'periodicals_issue', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'D', max_length=1),
                      keep_default=False)


        # Changing field 'Issue.description'
        db.alter_column(u'periodicals_issue', 'description', self.gf('djangocms_text_ckeditor.fields.HTMLField')())

    def backwards(self, orm):
        # Deleting field 'Issue.status'
        db.delete_column(u'periodicals_issue', 'status')


        # Changing field 'Issue.description'
        db.alter_column(u'periodicals_issue', 'description', self.gf('django.db.models.fields.TextField')(max_length=200))
