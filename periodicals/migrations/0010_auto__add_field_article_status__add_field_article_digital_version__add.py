...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'periodicals_article', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'D', max_length=1),
                      keep_default=False)

        # Adding field 'Article.digital_version'
        db.add_column(u'periodicals_article', 'digital_version',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'article_digital_versions', null=True, to=orm['filer.File']),
                      keep_default=False)

        # Adding field 'Article.organization'
        db.add_column(u'periodicals_article', 'organization',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Article.is_commercial'
        db.add_column(u'periodicals_article', 'is_commercial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Article.comment'
        db.add_column(u'periodicals_article', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'Article.description'
        db.alter_column(u'periodicals_article', 'description', self.gf('djangocms_text_ckeditor.fields.HTMLField')())

    def backwards(self, orm):
        # Deleting field 'Article.status'
        db.delete_column(u'periodicals_article', 'status')

        # Deleting field 'Article.digital_version'
        db.delete_column(u'periodicals_article', 'digital_version_id')

        # Deleting field 'Article.organization'
        db.delete_column(u'periodicals_article', 'organization')

        # Deleting field 'Article.is_commercial'
        db.delete_column(u'periodicals_article', 'is_commercial')

        # Deleting field 'Article.comment'
        db.delete_column(u'periodicals_article', 'comment')


        # Changing field 'Article.description'
        db.alter_column(u'periodicals_article', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'periodicals.article': {
            ...
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'articles'", 'blank': 'True', 'to': u"orm['periodicals.Author']"}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "u'D'", 'max_length': '1'}),
